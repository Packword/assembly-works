...
extern "C" void one(int* numbers, int numbers_size, int* result, int xmin);
extern "C" void two(int* array, int array_size, int xmin, int* intervals, int intervals_size, int* result);
...
int main() {
	...
	one(numbers, numbers_size, mod1_result, xmin);

	two(mod1_result, numbers_size, xmin, intervals, intervals_size, mod2_result);
